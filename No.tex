...
\begin{lstlisting}
https://github.com/Vallidevibolla/vallidevi/blob/main/Collinear.py
\end{lstlisting}
%
...
\rightarrow
\myvec{k-6&5\\9&-6}
\xleftrightarrow[\rowinterchange]{R_2\rightarrow R_1}
\myvec{9&-6\\k-6&5}\\
\rightarrow\myvec{9&-6\\0&9\times5-(-6\times (k-6))}\\
\rightarrow\myvec{9&-6\\0&9+6k}\\
\xrightarrow[\rowdivision]{R_2\rightarrow R_2/6}
\rightarrow\myvec{9&-6\\0&\frac{3}{2}+k}
\end{align*}

Equalising R_2 to 0 
\implies{k+\frac{3}{2}{=}0}\\ 
\implies{k}=\frac{-3}{2}
